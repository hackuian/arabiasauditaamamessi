                ...
                <h3>Datos del Arbitro</h3>
                    <div class="panel-body">
						...
						<div class="form-group">
		                    ...
		                    <input type="text" class="form-control" id="apellido_paterno" name="apellido_paterno" placeholder="Apellido Paterno" value="{{ old('apellidos') }}">
                        </div>
                        
                        <div class="form-group">
        		            <label for="apellido_materno">Apellido Materno</label>
		                    <input type="text" class="form-control" id="apellido_materno" name="apellido_materno" placeholder="Apellido Materno" value="{{ old('apellidos') }}">
                        </div>

                        <div class="form-group">
							<label for="foto">Foto</label>
		                    <input type="file" class="form-control filestyle" id="foto" name="foto" data-buttonName="btn-primary" data-buttonText="Seleccionar" data-size="sm" placeholder="Foto">

						</div>
                        <div class="form-group">
							<label for="nro_camiseta"></label>
		                    <input hidden type="number" class="form-control" id="numero" name="nro_camiseta" placeholder="1-99" value="0">
                        ...
                        <input  hidden type="text" class="form-control" name="posicion" placeholder="1" value="ala">
					    </div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class='input-group date' id='fecha_nacimiento'>
										<input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" placeholder="Fecha Nacimiento" value="{{ old('fecha_ini') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input hidden type="text" class="form-control" id="id_equipo" name="id_equipo" placeholder=" Equipo" value="99">
                        </div>
