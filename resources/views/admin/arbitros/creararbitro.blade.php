                ...
                <h3>Datos del Arbitro</h3>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
		                    ...
		                    <input type="file" class="form-control filestyle" id="foto" name="foto" data-buttonName="btn-primary" data-buttonText="Seleccionar" data-size="sm" placeholder="Foto" accept=".jpg, .png, .jpeg">
