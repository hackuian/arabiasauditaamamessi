			...
			<form class="card-block" method="post" enctype="multipart/form-data">
                ...
                <h3>Datos del Jugadores</h3>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
							<label for="ruta_imagen">Numero de Camiseta</label>
		                    <input type="number" class="form-control filestyle" id="numero" name="numero" data-buttonName="btn-primary" data-buttonText="Seleccionar" data-size="sm" placeholder="Numero Camiseta">

						</div>
                        <div class="form-group">
							<label for="tipo_evento">Posicion</label>
                            <input type="text" class="form-control" id="posicion" name="posicion" placeholder="Posicion" value="{{ old('posicion') }}">
					    </div>
